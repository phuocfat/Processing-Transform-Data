...
config_file_json          = info_json["BSR"]
file_path           = config_file_json["URI_BSR"]
...
# function_formatter(file_path_raw_data, file_path_data_formated,"BSR_SL_TonKho_20240101.xlsx", len_catalog, len_columns)
