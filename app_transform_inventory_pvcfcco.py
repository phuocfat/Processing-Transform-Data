...
config_file_json          = info_json["PVCFCCO"]
file_path           = config_file_json["URI_PVCFCCO"]
...
print(file_path_raw_data, file_path_data_formated)
...
def function_formatter(file_path_raw_data, file_path_data_formated, name_file, len_catalog, len_columns):
    ...
    raw_data.rename(columns={0: names_columns[0], 1: names_columns[1], 2: names_columns[2], 3: names_columns[3], 4: names_columns[4], 5: names_columns[5]}, inplace=True)
...
# function_formatter(file_path_raw_data, file_path_data_formated,"PVFCCo_SL_TonKho_20240101.xlsx", len_catalog, len_columns)
